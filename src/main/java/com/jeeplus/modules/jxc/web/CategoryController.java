...
import com.jeeplus.modules.jxc.service.CategoryService;
 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/jxc/category")
public class CategoryController extends BaseController {
	 ...
	 * 类型列表页面
	 */
	@RequiresPermissions("jxc:category:list")
	@RequestMapping(value = {"list", ""})
	public String list(Category category,  HttpServletRequest request, HttpServletResponse response, Model model) {
	
		model.addAttribute("category", category);
		return "modules/jxc/categoryList";
	}

	/**
	 * 查看，增加，编辑类型表单页面
	 */
	@RequiresPermissions(value={"jxc:category:view","jxc:category:add","jxc:category:edit"},logical=Logical.OR)
	...
	public String form(Category category, Model model) {
		...
		model.addAttribute("category", category);
		return "modules/jxc/categoryForm";
	}
	 ...
	 */
	@ResponseBody
	@RequiresPermissions(value={"jxc:category:add","jxc:category:edit"},logical=Logical.OR)
	 ...
	 */
	@ResponseBody
	@RequiresPermissions("jxc:category:del")
