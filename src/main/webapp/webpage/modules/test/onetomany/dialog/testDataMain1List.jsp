...
<head>
	...
	<%@include file="testDataMain1List.js" %>
</head>
<body>
	...
	<div id="search-collapse" class="collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="testDataMain1" class="form form-horizontal well clearfix">
	...
	<!-- 表格 -->
	<table id="testDataMain1Table"   data-toolbar="#toolbar"></table>
