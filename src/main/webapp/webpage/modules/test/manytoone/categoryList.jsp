			...
			<div class="col-sm-12">
				<div class="pull-left treetable-bar">
					<shiro:hasPermission name="test:manytoone:category:add">
						<a id="add" class="btn btn-primary" onclick="jp.openSaveDialog('新建商品类型', '${ctx}/test/manytoone/category/form','800px', '500px')"><i class="glyphicon glyphicon-plus"></i> 新建</a><!-- 增加按钮 -->
					</shiro:hasPermission>
