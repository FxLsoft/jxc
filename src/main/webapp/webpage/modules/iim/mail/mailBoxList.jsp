                        ...
                        <tbody>
                        	...
                        	<c:forEach items="${page.list}" var="mailBox">
								<tr>
									...
									<td>
										<a href="${ctx}/iim/mailBox/delete?id=${mailBox.id}" onclick="return jp.confirm('确认要删除该站内信吗？', this.href)"   class="btn btn-info btn-xs btn-danger"><i class="fa fa-trash"></i> 删除</a>
									</td>
								</tr>
							</c:forEach>
