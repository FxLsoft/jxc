	...
	<script type="text/javascript">
		...
		function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/jxc/category/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
		   ...
		   <tbody>
				<tr>
					...
					<td class="width-35">
						...
						title="父级编号" url="/jxc/category/treeData" extId="${category.id}" cssClass="form-control " allowClear="true"/>
					</td>
