	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/jxc/agency"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="agency" action="${ctx}/jxc/agency/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="plateNumber" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
